...
public class User implements UserDetails {
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQUENCIA_USER")
	@SequenceGenerator(allocationSize = 1, initialValue = 1, name = "SEQUENCIA_USER", sequenceName = "SEQ_USER")
	private Long id;
